...
const tr: T = {
  ...
  storyText:
    "Hayatlarımızı birleştirmeye karar verdik. Bu yolculuğun hikâyesini sizinle paylaşmak istiyoruz.",
  ...
  memoryApprovalNotice:
    "Mesajınız düğün sahipleri tarafından onaylandıktan sonra burada görünecektir.",
  ...
  rsvpSuccessMessage:
    "LCV'niz kaydedildi. Sizi aramızda görmekten mutluluk duyacağız.",
  ...
  contactText:
    "Düğünümüzle ilgili sorularınız için bizimle iletişime geçebilirsiniz.",
